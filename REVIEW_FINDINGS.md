...
total is correct is not established, and switching the filter changes what gets
audited, so it is NOT changed here: the committed filter yields a
self-consistent, clean audit, and a gate is not the place to land an unverified
change.
